 ...
 */
public abstract class RestWebService extends AsyncTask<Void, Void, String> implements RestWebServiceInterface {
    ...
    public RestWebService(Context context, RestRequest restRequest){
        super();
